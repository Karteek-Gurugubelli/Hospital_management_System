...
<body>
  ...
  <div class="container">
    ...
    <select id="doctor" name="doctor" onchange="showUser4(this.value)">
  <option value="">- Select doctor -</option>
  <option value="1">Dr.Krishna Kumar</option>
  <option value="2">Dr.Harshini Gupta</option>
  <option value="3">Dr.Ramesh Naidu</option>
  <option value="4">Dr.Harish</option>
  <option value="5">Dr.Mohan Pratap</option>
  <option value="6">Dr.Kamal Nath</option>
  
  <option value="9">None</option>
    </select>
<br/>
     <label for="date"><b>Date</b></label>
    <input type="date" placeholder="Enter phone number" name="date" min="2019-11-02" required><br/><br/>

     <label for="time"><b>time</b></label>
    <input type="time" placeholder="Enter phone number" name="time" required>
